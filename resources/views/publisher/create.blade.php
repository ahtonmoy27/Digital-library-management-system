    ...
    <div class="container">
        <div class="row">
            ...
            <div class="offset-md-7 col-md-2">
              <a class="add-new bg-primary text-white" href="{{ route('publishers') }}">All Publishers</a>
            </div>
        </div>
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <form class="yourform" action="{{ route('publisher.store') }}" method="post" autocomplete="off">
                    ...
                    <input type="submit" name="save" class="btn btn-danger bg-primary text-white" value="save" required>
                </form>
            </div>
        </div>
    </div>
